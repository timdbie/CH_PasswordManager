...
db_path = os.path.join(dir_path, 'pw.db')
...
def popUp():
    ...
    btn = Button(popUpWindow, command=addEntry, text="Add Entry", width=45, height=2, bg="green", fg="white", border=0)
...
def loginScreen():
    ...
    def checkPassword():
        ...
        if password:
            ...
            txt.delete(0, 'end')
            lbl1.config(text="Password is incorrect")
...
def vaultScreen():
    ...
    def removeEntry(input):
        warningPopUp = messagebox.askyesno("Warning", "Delete this entry?")
    ...
    headerbtn = Button(headerframe, text="Add Entry", fg="white", bg="green", border=0, command=popUp)
